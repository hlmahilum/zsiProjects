 var vehicledriverpao = (function(){
    ...
    $(".main-nav-tabs").find('a[data-toggle="tab"]').unbind().on('shown.bs.tab', function(e){
        ...
        if(gActiveTab === "Vehicle Devices"){
            $("#searchVal").attr('placeholder','Search vehicles...');
            $("#searchDiv").removeClass("hide"); 
            displayDevices();
        }
        if(gActiveTab === "Load Personnel"){
            $("#searchDiv").removeClass("hide"); 
            $("#searchVal").attr('placeholder','Search Loading Personnel...');
             displayLoadPersonnel();
        }
        if(gActiveTab === "Loading Devices"){
            $("#searchDiv").removeClass("hide"); 
            $("#searchVal").attr('placeholder','Search Loading Devices...');
            displayLoadDevices();
        }
    ...
    _public.submitInactive                  = function(){
        $("#gridInactivePersonnel").jsonSubmit({
             procedure: "load_personnel_upd"
            ,optionalItems: ["is_active"]
            ,onComplete: function (data) {
                if(data.isSuccess===true) zsi.form.showAlert("alert"); 
                displayInactivePersonnel();
                displayLoadPersonnel();
            }
        }); 
    };
    _public.DeleteInactive      = function(){ 
        ...
        /*$("#gridInactivePersonnel").deleteData({
            tableCode: "ref-00011"
            ,onComplete : function(d){
                if(d.isSuccess===true) {
                    zsi.form.showAlert("alert");
                    $('#gridInactivePersonnel').trigger('refresh');
                }
    ...
    function getTemplates(){
        ...
        .bsModalBox({
            ...
            , body      : gTw.new().modalBodyInactive({grid:"gridInactivePersonnel",onClickSaveInactive:"vehicledriverpao.submitInactive();",onClickDeleteInactive:"vehicledriverpao.DeleteInactive();"}).html()  
        });
    ...
    function displayVehicles(){  
        ...
        $("#gridVehicles").dataBind({
            ...
            ,dataRows       : [
                ...
                ,{text: "Conduction No."            ,name:"conduction_no"            ,type:"input"                 ,width : 100   ,style : "text-align:center;" }
                ,{text: "Route Code"                ,width : 500   ,style : "text-align:left;"
                    ,onRender  :  function(d) {  
                       _routeIds= app.svn(d,"route_id");
                        return app.bs({name:"route_id"                ,type:"select"      ,value: app.svn(d,"route_id")       ,style:"text-align:left"});
                    }     
                }
                ,{text: "Route No"                  ,name:"route_no_id"                 ,type:"select"                ,width : 500   ,style : "text-align:left;"}
                ...
                ,{text:"Driver"                                       ,width:250         ,style:"text-align:center"
                    ,onRender : function(d){
                            return app.bs({name:"dummy"                ,type:"input"      ,value: app.svn(d,"driver")       ,style:"text-align:left"});
                    }
                }
                ,{text:"PAO"                                       ,width:250         ,style:"text-align:left"
                    ,onRender : function(d){
            ...
            ,onComplete: function(o){
                ...
                _zRow.find("[name='route_no_id']").dataBind({
                    sqlCode      : "D1509"
                    ,parameters  : {client_id:app.userInfo.company_id,route_id:_routeIds}
                    ,text         : "route"
                    ,value        : "route_no_id"
    ...
    function displayDrivers(){
        ...
        $("#gridDriversLicensed").dataBind({
            ...
            ,dataRows       : [ 
                ...
                ,{text  : "PAO License No."                 ,width : 100           ,style : "text-align:center;"          ,type:"input"       ,name:"pao_license_no"}
                ,{text  : "PAO License Expr. Date"          ,width : 120           ,style : "text-align:center;"          
                     ,onRender : function(d){ 
                        return app.bs({name:"pao_license_exp_date"       ,type:"input"       ,value: app.svn(d,"pao_license_exp_date").toShortDate()});
                    }
                }
            ...
            ,onComplete: function(o){
                ...
                this.find("input[name='driver_license_exp_date'],input[name='pao_license_exp_date']").datepicker({
                      pickTime  : false
                    , autoclose : true
                    , todayHighlight: true
                });
    ...
    function displayPAO(){    
        ...
        $("#gridPAO").dataBind({
            ...
            ,dataRows       : [ 
                ...
                ,{text:"License No."            ,type:"input"           ,name:"pao_license_no"      ,width:100        ,style : "text-align:center;"}
                ,{text:"License Expr. Date"                                                         ,width:120        ,style : "text-align:center;"          
                    ,onRender : function(d){ 
                        return app.bs({name:"pao_license_exp_date"              ,type:"input"               ,value: app.svn(d,"pao_license_exp_date").toShortDate()}); 
                    }
            ...
            ,onComplete: function(o){ 
                ...
                this.find("input[name='pao_license_exp_date']").datepicker({
                      pickTime  : false
                    , autoclose : true
                    , todayHighlight: true
                });
    ...
    function displayDevices(){
        ...
        $("#gridDevices").dataBind({
            ...
            ,dataRows       : [
                ...
                ,{text: "Vehicle Plate No."                                              ,width: 200      ,style: "text-align:center;"
                    ,onRender   : function(d){
                         return app.bs({name:"vehicle_id"             ,type:"select"      ,value: app.svn(d,"vehicle_id")        ,style: "text-align:center;"});
                    }
                }
            ...
            ,onComplete: function(){
                ...
                this.find("[name='vehicle_id']").dataBind({
                    sqlCode : "D1264"
    ...
    function displayAddNewDriverPao(is_driver,is_pao){
        ...
        $("#gridNewDriverPao").dataBind({
                ...
                ,dataRows       : [
                        ...
                        ,{text:"Driver License No."            ,type:"input"           ,name:"driver_license_no"   ,width:100          ,style : "text-align:center;"}
                        ,{text:"Driver License Expr. Date"                                                         ,width:120          ,style : "text-align:center;"          
                             ,onRender : function(d){ 
                                return app.bs({name:"driver_license_exp_date"       ,type:"input"       ,value: app.svn(d,"driver_license_exp_date").toShortDate()});
                            }
                        }
            ...
            ,onComplete: function(){
                var _this = this;
                var _zRow = _this.find(".zRow");
                _this.find("[name='driver_license_exp_date'],[name='pao_license_exp_date']").datepicker({
                     pickTime  : false
                    , autoclose : true
                    , todayHighlight: true
                });
    ...
    function displayLoadPersonnel(){ 
        var cb = app.bs({name:"cbFilter1",type:"checkbox"});  
        var _clientId = app.userInfo.company_id;
        $("#gridLoadPersonnel").dataBind({
             sqlCode        : "L1498" 
            ,height         : $(window).height() - 400
            ,parameters     : {company_id: _clientId} 
            ,blankRowsLimit : 5
            ,dataRows       : [
                 { text  : cb , width : 25   , style : "text-center" 
                    ,onRender  :  function(d)  
                ...
                ,{text: "Middle Name"                       ,name:"middle_name"                 ,type:"input"       ,width : 150        ,style : "text-align:center;"}
                ,{text: "Name Suffix"                       ,name:"name_suffix"                 ,type:"input"       ,width : 80         ,style : "text-align:center;"}
                ,{text: "Active?"                           ,name:"is_active"                   ,type:"yesno"       ,width :60           ,style:"text-align:center" ,defaultValue:"Y"} 
            ]
            ,onComplete: function(d){
                var _dataRows = d.data.rows; 
                $("[name='cbFilter1']").setCheckEvent("#gridLoadPersonnel input[name='cb']");   
            }
        });
    }
    function displayInactivePersonnel(){
        var cb = app.bs({name:"cbFilter",type:"checkbox"});
        var _clientId = app.userInfo.company_id;
        $("#gridInactivePersonnel").dataBind({
             sqlCode    : "L1498"
            ,parameters : {company_id:_clientId,is_active: "N"}
            ...
            ,dataRows   : [ 
                ...
                ,{text: "Middle Name"                       ,name:"middle_name"                 ,type:"input"       ,width : 150        ,style : "text-align:center;"}
                ,{text: "Name Suffix"                       ,name:"name_suffix"                 ,type:"input"       ,width : 80         ,style : "text-align:center;"} 
                ,{text: "Active?"                           ,name:"is_active"                   ,type:"yesno"       ,width : 70         , style : "text-align:center;"       ,defaultValue:"N"}
            ]
            ,onComplete: function(o){
                this.find("[name='cbFilter']").setCheckEvent("#gridInactivePersonnel input[name='cb']");
            }
        });  
    } 
    function displayLoadDevices(){
        var _ctr = 1;
        var _cb = app.bs({name:"cbFilter8",type:"checkbox"}); 
        var _searchVal = $("#searchValDevice").val();
        $("#gridLoadDevices").dataBind({
             sqlCode        : "L1497"
            ,parameters     : {company_id: app.userInfo.company_id} 
            ,height         : $(window).height() - 491      
            ,dataRows       : [
                {text: _cb                                                                  ,width:25           ,style:"text-align:left"
                     ,onRender : function(d){
                         return app.bs({name:"dummy"            ,type:"hidden"      ,value: app.svn(d,"name")}) 
                              + app.bs({name:"dummy"            ,type:"hidden"      ,value: app.svn(d,"hash_key")})
                              + (d !== null ? app.bs({name:"cb"         ,type:"checkbox"}) : "" );
                     }
                }
                ...
                ,{text:"View QR"                                       ,width:60         ,style:"text-align:center"
                    ,onRender : function(d){
                            var _link = "<a href='javascript:void(0)' ' title='View' onclick='vehicledriverpao.showModalViewQR(this,\""+ app.svn (d,"hash_key") +"\",\""+ app.svn (d,"name") +"\")'><i class='fas fa-eye'></i></a>";
                            return (d !== null ? _link : "");
                    }
                }
                ,{text: "Device Id"                                                                          ,width: 60      ,style: "text-align:center;"
                ...
                ,{text: "Device Name"                                ,name:"name"         ,type:"input"        ,width: 160      ,style: "text-align:center;"}
                ,{text: "Mobile No."                                                                          ,width: 120      ,style: "text-align:center;"
                    ,onRender   : function(d){
                        return app.bs({name:"mobile_no"             ,type:"input"       ,value: app.svn(d,"mobile_no")         ,style: "text-align:center;"})
                             + app.bs({name:"is_active"             ,type:"hidden"      ,value: app.svn(d,"is_active")}) ;
            ...
            ,onComplete: function(){
                ...
                this.find("[name='cbFilter8']").setCheckEvent("#gridLoadDevices input[name='cb']");
                _ctr = 1;
            }
        });
    } 
    ...
    function exportExcel(fName){
        ...
        let _h="";
        let _b="";  
        let convertExcelData = function(filename){
            var downloadLink;
        ...
        let _vehicles = function(d,ctr){
            _h='<tr>'+'<th>Line No</th>'+'<th>Plate No</th>'+'<th>Odometer Reading</th>'+'</tr>' 
            _b='<tr>'+'<td>'+ctr+'</td>'+'<td>'+d.vehicle_plate_no+'</td>'+'<td>'+d.odometer_reading.toMoney()+'</td>'+'</tr>' 
        }
        let _drivers = function(d){
            _h='<tr>'+'<th>Employee No</th>'+'<th>Last Name</th>'+'<th>First Name</th>'+'<th>Middle Name</th>'+'<th>Gender</th>'
                +'<th>Mobile No</th>'+'<th>License Expire Date</th>'+'</tr>'  
            _b='<tr>'+'<td>'+d.employee_no+'</td>'+'<td>'+d.last_name+'</td>'+'<td>'+d.first_name+'</td>'+'<td>'+d.middle_name+'</td>' +'<td>'+d.gender+'</td>'  
                +'<td>'+d.contact_phone_no+'</td>' +'<td>'+d.driver_license_exp_date+'</td>'
            +'<tr>' 
        }
        let _Paos = function(d){
            _h='<tr>'
                +'<th>Employee No</th>'+'<th>Last Name</th>'+'<th>First Name</th>'+'<th>Middle Name</th>'+'<th>Gender</th>'+'<th>Mobile No</th>'+'<th>License No.</th>'+'<th>License Expire Date</th>'+'</tr>'  
            _b='<tr>'
                +'<td>'+d.employee_no+'</td>'+'<td>'+d.last_name+'</td>'+'<td>'+d.first_name+'</td>'+'<td>'+d.middle_name+'</td>' +'<td>'+d.gender+'</td>' +'<td>'+d.contact_phone_no+'</td>'+'<td>'+d.pao_license_no+'</td>'+'<td>'+d.pao_license_exp_date+'</td>' 
            +'<tr>' 
        } 
    ...
    $("#btnInActivePersonnel").click(function (){
        var g$mdl = $("#" + mdlInactive);
        g$mdl.find(".modal-title").text("Inactive Load Personnel") ;
        g$mdl.modal({ show: true, keyboard: false, backdrop: 'static' });
        displayInactivePersonnel();
    }); 
    $("#btnSaveLoadPersonnel").click(function(){
        $("#gridLoadPersonnel").jsonSubmit({
             procedure: "load_personnel_upd" 
            ,optionalItems: ["is_active"]
            ,onComplete : function (data) { 
                if(data.isSuccess===true) zsi.form.showAlert("alert");
    ...
    $("#btnSaveLoadDevices").click(function(){
        $("#gridLoadDevices").jsonSubmit({
             procedure: "load_devices_upd" 
            ,notIncludes : ["dummy","cb"]
            ,optionalItems: ["is_active"]
            ,onComplete : function (data) { 
                if(data.isSuccess===true) zsi.form.showAlert("alert");
                $("#gridLoadDevices").trigger("refresh");
            }
        }); 
    }); 
        ...
        var _getData = function(cb){
            ...
            for(var i=0; i < _data.length; i++ ){
                ...
                _h +='<td><div id="empId_'+_o.id+'" style="'+ _style +'">'
                    ...
                    +'        <div class="m-0 font-weight-bold" style="font-size:15px !important;padding:0px !important;margin:0px !important;">' +gClientName +'</p>'+_fulName+'</div>'
                    +'    </div>'
    ...
    $(".btnPrintDevicesQr").click(function(){
        ...
        if(_data.length > 0){
            setTimeout(function(){
                $('#myModal').find("#msg").text("Are you sure you want to print this vehicle devices QR's?");
                $('#myModal').modal('show');
            },100);
        }else alert("Please select checkbox to proceed.");
    });
    $(".btnPrintLoaderDevicesQr").click(function(){
        var _$tbody = $("#qrTable > tbody");
        var _style = "text-align:center;border:1px solid black; margin-left: 5px; margin-top: 5px;width: 204px !important;padding:3px;";
        var _createQR = function(text){new QRCode(document.getElementById(text), {width:160, height:160}).makeCode(text);}
        var obj = {};
        var _data = [];
        var  _row= $("#gridLoadDevices").find("[name='cb']:checked").parent(".zCell");
        ...
        if(_data.length > 0){
            setTimeout(function(){
                $('#myModal').find("#msg").text("Are you sure you want to print this loader devices QR's?");
                $('#myModal').modal('show');
            },100);
        }else alert("Please select checkbox to proceed.");
    });
    ...
    $("#btnUploadExcel,#btnPAOUploadExcel,#btnDriversUploadExcel").click(function(){
            var _colName = $(this)[0].id;
            var _grid = "";
            var _fileName = gActiveTab;
            if(_colName==="btnUploadExcel") _grid = "#gridVehicles"; exportExcel(_fileName); return;
            if(_colName==="btnDriversUploadExcel") _grid = "#gridDriversLicensed"; exportExcel(_fileName); return;
            if(_colName==="btnPAOUploadExcel") _grid = "#gridPAO"; exportExcel(_fileName); return;
