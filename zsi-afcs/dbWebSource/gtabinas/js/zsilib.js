    ...
    ,zsi= {
        ...
        ,__setExtendedJqFunctions   : function(){
            ...
            $.fn.dataBindGrid       = function(o){
                var _obj                = this
                    ...
                    ,trItem             = function(o){
                        ...
                        _table.append(_$row);
                        _$row.find("input").attr("autocomplete", "off");
                        _table.on('dragstart', function () {
                            return false;
                        });
            ...
            $.fn.getCheckBoxesValues= function(){
                var _r = [],_h = "input[type=hidden]", _a = arguments;
                var _sel = ( _a.length > 0 ? _a[0] :_h );        
                if(this){
                    $.each(this,function(){
                        if( $(this.parentNode).find(_h).length > 0 )
                            _r.push( $(this.parentNode).children(_sel).val() ); //get primary hidden field value
                        else 
                            _r.push( $(this).val() ); //get check box value 
                    });
                }
                return _r;    
            };              
        ...
        ,__setPrototypes            : function(){
            ...
            String.prototype.toShortDateTime = function () {
              ...
              return _date.getMonth()+1 + "/" + (_date.getDate() >= 10? _date.getDate() : "0" + _date.getDate()) + "/" + _date.getFullYear() + " " + strTime;
            };
            String.prototype.toShortTime = function () {
              if(!isValidDate(this)) return "";
              var _date=new Date( Date.parse(this) );
              var h = _date.getHours();
              var m = _date.getMinutes();
